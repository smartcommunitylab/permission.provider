		...
		<div class="policy_text">
			...
			<p class="tool_tit">1. INTRODUCTION: TERMS & CONDITIONS - Applicable worldwide expect where we publish specific territorial terms
                ...
                <p class="tool_desc">These Terms and conditions are available in the Application installed in your device or in the Website. You
                    ...
                    by the User and hosted in the Framework are property of the Consortium. However an artefact provider
                    has the right to remove its own published artefacts, independently on whether they are used by others
                ...
                <p class="tool_desc">Before using the Service, users must approve the Consent Form, which will be provided to them the first time
                    ...
                    (for more information about what sensitive data includes please see Article 8 of the DIRECTIVE 95/46/EC
                ...
                <p class="tool_desc">User may access data with no cost. Any derivative works that access these data should allow the access to
                    them with no cost.</p>
                <p class="tool_desc">Users are allowed to create new datasets either through the Framework or Application and will have full access
                    ...
                    belong both to the User and the framework maintainer (Consortium). Users will maintain control of those
                    datasets that they create and will be able to update or remove them. Datasets derived from existing public
                    datasets will be shared within the Framework and cannot be removed unless it includes personal or private
                ...
                <p class="tool_desc">The Website, Application, Framework is property of the Consortium. Any other WeLive artefact is property
                    of its authors and the Framework manager, i.e. the organization hosting the WeLive solution. Third party
                    artefacts' exploitation, if a pricing model is set up for the artefact, will be shared by the authors
                    and the Framework hosting organization. </p>
