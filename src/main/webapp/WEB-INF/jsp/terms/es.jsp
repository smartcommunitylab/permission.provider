 <div id="policy_screen">
        ...
        <div class="policy_box">
            ...
            <div class="policy_text">
                ...
                <p class="tool_tit">1. INTRODUCCIÓN: TÉRMINOS Y CONDICIONES - aplicables en todo el mundo salvo en aquellos sitios que se hayan
                    publicado términos y condiciones específicas para dicho territorio </p>
                <p class="tool_desc">Estos términos y condiciones ("Términos") contienen información importante acerca de los derechos, obligaciones
                    ...
                    Web/Plataforma/Sistema") o cuando accede, descarga y usa la aplicación WeLive Player y los diferentes
                    servicios públicos ("Aplicación") y cualquiera de los servicios que se proporcionan a través de ella.
                    Todos los artefactos que forman parte del sistema, es decir: datasets, building blocks y aplicaciones,
                    gestionadas dentro de la solución WeLive son gestionados por la plataforma ("Plataforma"). El WeLive
                    Player actúa como una "tienda" para aquellas aplicaciones desarrolladas dentro de la plataforma WeLive,
                    permitiendo a los Usuarios encontrar qué aplicaciones están disponibles en su entorno haciendo uso de
                    información pública. Además, es posible que desde la aplicación o desde el Sitio Web pueda acceder a
                    otros artefactos ("Artefacto") como: aplicationes, building blocks y datasets. La plataforma, Sitio Web
                    y la aplicación, salvo que se indique lo contrario, son proporcionados por todos los socios que conforman
                    el consorcio WeLive ("Consorcio"). El proyecto WeLive (http://www.welive.eu/) ha sido financiado por
                    el programa marco de la Unión Europea (H2020) dentro del acuerdo nº 645845.</p>
                ...
                <p class="tool_desc">El Sitio Web, Aplicación y Plataforma permite la publicación de información. El Usuario se hace responsable
                    ...
                    Sitio Web, Aplicación y Plataforma.</p>
                <p class="tool_desc">El Usuario se compromete a no publicar, ni fomentar la publicación de: </p>
                <ul>
                ...
                <p class="tool_desc">La plataforma WeLive proporciona una API pública con un conjunto de métodos a través de los cuales se puede
                    modificar el estado de los artefactos dados de alta en el sistema. Únicamente a los usuarios que se hayan
                ...
                <p class="tool_desc">El Sitio Web, Aplicación, Plataforma, API pública, Servicios y Artefactos proporcionados por WeLive se ofrecen
                    y proporcionan sin ningún coste durante las dos fases de ejecución del Piloto del proyecto. En otro ámbito,
                    la utilización de Aplicaciones, Servicios y Artefactos proporcionados por terceras partes puede implicar
                    algún tipo de coste. Los pagos requeridos para la utilización de los servicios proporcionados por terceras
                ...
                <p class="tool_desc">Antes de comenzar a usar el Servicio, los Usuarios deben aprobar el documento de Términbos y Condiciones
                    ...
                    forma correcta. El Sitio Web en ningún caso le solicitará datos sensibles (para más información acerca
                    de qué se considera datos sensibles, por favor, revisen el artículo 8 de la Directiva Europea 95/46/EC
                    - https://secure.edps.europa.eu/EDPSWEB/webdav/site/mySite/shared/Documents/EDPS/DataProt/Legislation/Dir_1995_46_EN.pdf).
                    TECNALIA y el resto del consorcio de WeLive tratará esos datos adecuadamente y siempre de acuerdo a las
                    exigencias de la legislación local vigente o, en su ausencia, la legislación europea para la protección
                    de los datos que tendrá efecto en el año 2018. Así mismo el Usuario deberá proteger su cuenta usando
                    los medios que se le proporcionan para ello como son, sin limitarse a ellos, el uso de una contraseña
                    adecuada, el cambio periódico de la misma, o no compartir los datos de la cuenta. TECNALIA y el resto
                    del consorcio de WeLive usará los datos proporcionados por los Usuarios para gestionar y monitorizar
                    el uso del Sitio Web, Plataforma, Aplicaciones y los artefactos de WeLive. En ningún momento negociará
                    con los datos y los mismos serán utilizados únicamente para la gestión del uso del Sitio Web. </p>
                <p class="tool_desc">TECNALIA y el resto del consorcio de WeLive recopilarán información personal de los Usuarios, siempre sujeta
                    ...
                    para tratar de mejorar el mismo y hacer una evaluación del uso de cada uno de los servicios. De hecho,
                    dentro de esta información anonimizada, creada internamente por los componentes de WeLive, los usuarios
                    son identificados mediante un identificador único solamente conocido por el sistema WeLive. Esto permite
                    recuperar información sobre la ultilizacion de las distintas herramientas y artefactos que forman parte
                    de WeLive y será usada para generar métricas y visualizaciones de éstas que permitan al proyecto evaluar
                    en tiempo real la acepetacion de la plataforma y de los servicios. En ningún caso estas métricas y visualizaciones
                    revelarán los Identificadores de los usuarios. Esta información puede, también, ser utilizada para el
                    envío de recomendaciones personalizadas de acuerdo al perfil del usuario. Además, los datos personales
                    (correo electrónico) será unicamente usado para establecer comunicación directa con los Usuarios durante
                    el Piloto. Los datos personales nunca serán revelados a terceras partes a menos que el Usuario explicitamente
                    lo consienta. El Sitio Web explícitamente no recopila datos sensibles sobre los usuarios. Cualquier Aplicación
                    que recopile y/o use datos sensibles no está autorizada a usar ninguno de los componentes de WeLive para
                    ...
                    el siguiente documento oficial de la UE1. Los usuarios de cualquier aplicación compatible con el sistema
                    WeLive deben cumplir con esta restricción relativa al almacenamiento de datos personales sensibles dentro
                    de WeLive. </p>
                ...
                <p class="tool_desc">Se permite a los Usuarios la creación, actualización, modificación e inclusión de nuevos datos en la Plataforma
                    ...
                    generados por el usuario, en el caso de que no sean de naturaleza personal y/o privados, pertenecerán
                ...
                <p class="tool_desc">Los datos generados por los usuarios sobre datasets de carácter público son compartidos en la plataforma
                    y el usuario no tendrá la posibilidad de borrarlos a menos que incluyan datos de carácter personal o
                    privado. Cualquier rastro, como por ejemplo los Identificadores de Usuario, que pueda ser usado para
                    vincular a usuarios que quieren desregistrarse de la plataforma a través de los datos que crearon previamente
                    serán anonimizados vinculándolos a un ID genérico. En cualquier momento, el Usuario dispondrá de acceso
                    a los datos a traves del "CDV" desde donde podrá extraer todos sus datos personales. Del mismo modo,
                    a través del Open Data Stack ("ODS"), se permitirá al usuario a extraer los contenidos de los datos que
                    le pertenecen. Los nuevos datos creados serán de dominio público al igual que son los datos con los que
                    están trabajando y usando. </p>
                <p class="tool_desc">En el caso de que tenga la intención de publicar datos en WeLive que ya se encuentren disponibles en otros
                    sitios web o redes sociales, por favor refiérase a la política de privacidad de dichos sitios antes de
                    publicar con el fin de asegurarse el derecho a poder hacerlo. Asimismo, en el caso de tener la intención
                    de publicar datos de WeLive en otros sitios web, por favor, comprueben primero la política de privacidad
                    para asegurarse de que los presentes Términos y Condiciones de Uso no son incumplidos. En el cao de republicar
                    datos, es necesarioañadir una referencia al origen de los datos. </p>
                <p class="tool_desc">El consorcio WeLive no pagará ninguna contraprestación económica por los datos proporcionados. TECNALIA y
                    el resto del consorcio de WeLive se reserva el derecho de revisar los datos aportados y eliminarlos en
                    caso de considerar que no son correctos o que violan el propósito del sitio. El componente del sistema
                ...
                <p class="tool_desc">Una vez que el proyecto concluya, los datos publicados podrían tener un coste asociado a su consumo siempre
                    y cuando el creador de estos datos así determine. Por favor, si desea retener el copyright de sus datos
                    u obtener alguna contraprestación por ellos es preferible que no los publique.</p>


                <p class="tool_tit">6. EXACTITUD DE LOS DATOS</p>
                <p class="tool_desc">La información se proporciona tal cual la proporcionan las fuentes de datos; es decir, los valores/contenidos
                    no son modificados, aunque el formato en el que son exportados podría ser modificado para facilitar su
                    explotación posterior. TECNALIA y el resto del consorcio de WeLive no se hace responsable de la exactitud
                    de la misma ni de los daños y costes directos o indirectos, causados por el uso de esta información.
                    La Plataforma proporciona herramientas para automáticamente evaluar la calidad de los datos y verificar
                    su exactitud. </p>
                ...
                <p class="tool_desc">Se concede al usuario una licencia no exclusiva, revocable para copiar, instalar y usar la aplicación en
                    todos sus dispositivos y para usar el Servicio sin ningún coste. Esto no otorga al usuario ningún derecho
                    sobre la propiedad de la Aplicación y Artefactos que seguirán siendo de los autores. </p>
                ...
                <p class="tool_tit">11. INTERPRETACIÓN</p>
                <p class="tool_desc">El presente documento "Términos y Condiciones de Uso" del ecosistema WeLive ha sido escrito en Inglés y traducido
                    ...
                    versiones de este documento, la versión en inglés es la que prevalece con respecto al resto de versiones.</p>
